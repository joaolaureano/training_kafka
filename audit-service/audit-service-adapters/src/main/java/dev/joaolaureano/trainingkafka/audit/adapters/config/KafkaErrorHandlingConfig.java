...
import dev.joaolaureano.trainingkafka.audit.adapters.messaging.Topics;
...
public class KafkaErrorHandlingConfig {
    ...
    public CommonErrorHandler deadLetterErrorHandler(KafkaOperations<Object, Object> deadLetterKafkaTemplate,
        ...
        errorHandler.addNotRetryableExceptions(InvalidAuditException.class);
        return errorHandler;
    }
    ...
    public NewTopic applicationLogsDeadLetterTopic(DeadLetterProperties properties) {
        return TopicBuilder.name(properties.deadLetterTopicFor(Topics.AUDIT_EVENTS))
