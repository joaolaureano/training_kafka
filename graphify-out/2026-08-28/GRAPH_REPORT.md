...
Cohesion: 0.20
Nodes (7): OrderController, PlaceOrderRequest, PlaceOrderResponse, PlaceOrderUseCase, org.springframework.web.bind.annotation.PostMapping, org.springframework.web.bind.annotation.RequestMapping, org.springframework.web.bind.annotation.RestController
...
### Community 34 - "LogPersistenceConfiguration.java"
Cohesion: 0.17
...
### Community 35 - "logs/adapters/config/KafkaErrorHandlingConfig.java"
Cohesion: 0.24
...
### Community 36 - "LogFilter"
Cohesion: 0.16
Nodes (8): LogFilter, isAtLeast(), LogLevel, DEBUG, ERROR, INFO, WARN, parse()

### Community 37 - "LogController.java"
Cohesion: 0.19
Nodes (4): LogController, LogEntryView, LogQueryService, TimeRange

### Community 38 - "org.springframework.kafka.core.KafkaTemplate"
Cohesion: 0.29
...
- **Why does `DeadLetterProperties` connect `DeadLetterProperties` to `logs/adapters/config/KafkaErrorHandlingConfig.java`, `org.apache.kafka.clients.admin.NewTopic`, `SuspicionProperties`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `LogEntry` connect `LogEntry` to `org.junit.jupiter.params.ParameterizedTest`, `LogPersistenceConfiguration.java`, `LogFilter`, `LogController.java`, `InvalidLogException`, `IngestLogService`, `org.junit.jupiter.api.Test`?**
