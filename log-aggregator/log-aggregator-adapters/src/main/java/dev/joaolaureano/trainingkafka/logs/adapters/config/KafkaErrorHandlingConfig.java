...
import dev.joaolaureano.trainingkafka.logs.adapters.messaging.Topics;
...
public class KafkaErrorHandlingConfig {
    ...
    public CommonErrorHandler deadLetterErrorHandler(KafkaOperations<Object, Object> deadLetterKafkaTemplate,
        ...
        errorHandler.addNotRetryableExceptions(InvalidLogException.class);
        return errorHandler;
    }
    ...
    public NewTopic applicationLogsDeadLetterTopic(DeadLetterProperties properties) {
        return TopicBuilder.name(properties.deadLetterTopicFor(Topics.APPLICATION_LOGS))
