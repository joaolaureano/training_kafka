...
public class KafkaActivityLogPublisher {
     ...
     * senão o pedido. Nulo quando não há nenhum dos dois — caso de
     * {@code order.rejected}, em que o pedido nem chegou a existir; aí o sticky
     * partitioner distribui em lotes, que é o comportamento desejado.
     *
     ...
     * todos esses eventos numa partição só — exatamente o problema que este
