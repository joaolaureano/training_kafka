...
import dev.joaolaureano.trainingkafka.payment.adapters.messaging.Topics;
...
public class KafkaErrorHandlingConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "kafka.dlq", name = "create-topics", havingValue = "true", matchIfMissing = true)
    public NewTopic fraudEventsDeadLetterTopic(DeadLetterProperties properties) {
        return TopicBuilder.name(properties.deadLetterTopicFor(Topics.FRAUD_EVENTS))
                .partitions(properties.getPartitions())
                .replicas(properties.getReplicas())
                .build();
    }
